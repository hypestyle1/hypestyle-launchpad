...
const GOLD = '#D4AF37';
const SESSION_KEY = 'hy-win-takeover-seen';
...
// Toma de pantalla completa al entrar al sitio si Argentina ganó — a diferencia de un
// festejo en vivo (que depende de estar navegando en el segundo exacto del gol), esto
// se ve cualquiera que entre en los días posteriores al triunfo, mientras dure el
// estado "won". Se muestra una vez por sesión (sessionStorage), sin CTA ni link a
// producto — pura identidad.
export default function MatchWinTakeover() {
  const { phase } = useMaradonaEnglandStatus();
  ...
  return (
    ...
    >
      <div
        ...
        style={{
          backgroundImage: "url('/maradona/maradona-vs-england.jpg')",
      ...
      <div
        className="absolute inset-0"
        style={{
          background: `linear-gradient(160deg, rgba(13,27,61,0.94) 0%, rgba(27,59,111,0.92) 55%, rgba(117,170,219,0.80) 130%)`,
        }}
      />
      ...
      <div className="relative flex flex-col items-center gap-4 px-6 text-center">
        ...
        <h1
          ...
          style={{ fontSize: 'clamp(48px, 13vw, 140px)', textShadow: '0 4px 30px rgba(0,0,0,0.35)' }}
        >
          A la final
        </h1>
