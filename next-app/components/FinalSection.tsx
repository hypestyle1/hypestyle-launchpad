...
export default function FinalSection() {
  ...
  const oppName = match?.oppName || 'el rival';
    ...
    <div className="flex flex-col items-start gap-6 text-left">
      <div className="flex items-center gap-3">
        ...
        <span className="text-[10px] font-medium tracking-[0.25em] uppercase text-white/60">
          Mundial 26&apos; &middot; La gran final
        </span>
      </div>
  ...
  return (
    <section className="relative w-full overflow-hidden" style={{ background: '#0d1b3d' }}>
      ...
      <img src={IMG_SRC} alt="Messi, Mundial 26'" className="block md:hidden w-full h-auto" />
      <div className="md:hidden px-6 py-10">
        {content}
      </div>

      {/* Desktop: banner full-bleed, texto a la izquierda para no tapar a Messi (a la derecha en la foto) */}
