...
const megaMenu = {
  general: [
    ...
    { label: 'SALE', href: '/special-prices/', homeHash: 'back-in-stock', isNew: false, isSale: true },
  ],
  categorias: [
...
const mobilePanels = {
  main: {
    ...
    items: [
      ...
      { label: 'SALE',                     href: '/special-prices/', homeHash: 'back-in-stock', panel: null, isSale: true },
