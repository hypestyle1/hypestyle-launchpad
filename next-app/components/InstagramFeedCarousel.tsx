...
/**
 * Feed de Instagram: una tira de fotos a sangre completa, sin título ni
 * padding, pegada al bloque de arriba y al newsletter de abajo. Mismo patrón
 * que Shop the Look (scroll nativo + snap + drag con el mouse), sin librerías.
 *
 * Antes tenía encabezado ("Seguinos en Instagram" + @ + flechas) y aire arriba
 * y abajo; se sacó a pedido (14/09/2026) para que quede como la tira de EME
 * Studios: las fotos solas hablan. El título queda solo para lectores de
 * pantalla. El token sigue sin salir del servidor: lo único que baja al
 * cliente son los posts ya resueltos.
 *
...
export default function InstagramFeedCarousel({ posts }: { posts: InstagramPost[] }) {
  ...
  return (
    <section className="w-full" aria-labelledby="instagram-feed-title">
      <h2 id="instagram-feed-title" className="sr-only">
        Seguinos en Instagram: @hypestylearg
      </h2>
