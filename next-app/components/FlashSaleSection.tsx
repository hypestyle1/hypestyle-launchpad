  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background: 'radial-gradient(ellipse at center, rgba(255,45,45,0.12) 0%, transparent 70%)',
        }}
      />

      <div className="relative max-w-[1200px] mx-auto px-6 py-16 md:py-20 flex flex-col items-center text-center gap-10">
        ...
        <div className="flex flex-col items-center gap-2">
          ...
          <p
            className="font-black uppercase tracking-[0.1em] text-white/80"
        ...
        <div className="flex items-start gap-4 md:gap-8">
          ...
          <span
            className="font-mono font-black text-white/20 leading-none mt-1"
        ...
        {/* End date note */}
        <p className="text-[11px] tracking-[0.14em] uppercase text-white/35">
          Termina el jueves 25 de junio a las 22:00hs
        </p>
