  ...
  try {
    ...
    const rows = orders.map((o) => {
      ...
      return {
        ...
        fee: { provider: p.fee.provider, group: p.fee.group, economicCost: p.fee.economicCost, netReceived: p.fee.netReceived, otherCashDeduction: p.fee.otherCashDeduction, source: p.fee.source, breakdown: p.fee.breakdown, installments: p.fee.installments },
        taxWithholdings: p.taxWithholdings,
