...
// Sin 'use client' a propósito: este módulo lo importan tanto el hook
// hooks/useProduct.ts (browser) como app/producto/[slug]/page.tsx (servidor),
// que necesita el producto ya normalizado para generateMetadata, el JSON-LD y
// el notFound(). La normalización tiene que ser la misma en los dos lados o el
// HTML servido y el hidratado no coinciden.
...
/** Cuánto cachea Next el producto en el fetch del servidor, en segundos. */
