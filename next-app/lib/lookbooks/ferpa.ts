...
// Tie Dye Hoodie Drop — Ferpa x Hypestyle, septiembre de 2020: la colab más
...
const BUZO: Producto = { producto: 'Tie Dye Hoodie — Ferpa x Hypestyle', nota: 'Not for sale' };

export const FERPA: Lookbook = {
  dir: '/lookbook-ferpa',
  eyebrow: 'Style&Culture',
  title: 'Tie Dye Hoodie Drop — Ferpa x Hypestyle',
  ...
  bloques: [
    { tipo: 'reel', mp4: 'reel', poster: 'reel', titulo: 'Ferpa x Hypestyle — el reel del drop' },
