...
const DICT: Dict = {
  ...
  // — Lookbooks —
  // La interfaz de la página y, abajo, la intro de cada uno. Los nombres de
  // las piezas no se traducen: son catálogo, igual que en las fichas.
  'Ver producto': { EN: 'View product', PT: 'Ver produto', DE: 'Produkt ansehen', FR: 'Voir le produit', IT: 'Vedi il prodotto' },
  'Próximamente': { EN: 'Coming soon', PT: 'Em breve', DE: 'Demnächst', FR: 'Bientôt disponible', IT: 'Prossimamente' },
  'Agotado': { EN: 'Sold out', PT: 'Esgotado', DE: 'Ausverkauft', FR: 'Épuisé', IT: 'Esaurito' },
  // "Not for sale" viene del banner original del drop de Ferpa, así que en
  // español queda tal cual y solo se traduce para los demás idiomas.
  'Not for sale': { EN: 'Not for sale', PT: 'Fora de venda', DE: 'Nicht verkäuflich', FR: 'Hors vente', IT: 'Fuori vendita' },
  'Reproducir': { EN: 'Play', PT: 'Reproduzir', DE: 'Abspielen', FR: 'Lire', IT: 'Riproduci' },
  'El film': { EN: 'The film', PT: 'O filme', DE: 'Der Film', FR: 'Le film', IT: 'Il film' },
  'El reel': { EN: 'The reel', PT: 'O reel', DE: 'Das Reel', FR: 'Le reel', IT: 'Il reel' },
  'En Instagram': { EN: 'On Instagram', PT: 'No Instagram', DE: 'Auf Instagram', FR: 'Sur Instagram', IT: 'Su Instagram' },
  '¿Quién es Alfredo Genovese?': { EN: 'Who is Alfredo Genovese?', PT: 'Quem é Alfredo Genovese?', DE: 'Wer ist Alfredo Genovese?', FR: 'Qui est Alfredo Genovese ?', IT: 'Chi è Alfredo Genovese?' },
  'Fileteado Porteño x Alfredo Genovese — el film en la Villa 31': { EN: 'Fileteado Porteño x Alfredo Genovese — the film in Villa 31', PT: 'Fileteado Porteño x Alfredo Genovese — o filme na Villa 31', DE: 'Fileteado Porteño x Alfredo Genovese — der Film in der Villa 31', FR: 'Fileteado Porteño x Alfredo Genovese — le film à la Villa 31', IT: 'Fileteado Porteño x Alfredo Genovese — il film nella Villa 31' },
  'CULTO x Neo Pistea — el reel del drop': { EN: 'CULTO x Neo Pistea — the drop reel', PT: 'CULTO x Neo Pistea — o reel do drop', DE: 'CULTO x Neo Pistea — das Reel zum Drop', FR: 'CULTO x Neo Pistea — le reel du drop', IT: 'CULTO x Neo Pistea — il reel del drop' },
  'Tie Dye Hoodie Drop x Ferpa — el reel del drop': { EN: 'Tie Dye Hoodie Drop x Ferpa — the drop reel', PT: 'Tie Dye Hoodie Drop x Ferpa — o reel do drop', DE: 'Tie Dye Hoodie Drop x Ferpa — das Reel zum Drop', FR: 'Tie Dye Hoodie Drop x Ferpa — le reel du drop', IT: 'Tie Dye Hoodie Drop x Ferpa — il reel del drop' },
  'La Ciudad del Pop — el film': { EN: 'La Ciudad del Pop — the film', PT: 'La Ciudad del Pop — o filme', DE: 'La Ciudad del Pop — der Film', FR: 'La Ciudad del Pop — le film', IT: 'La Ciudad del Pop — il film' },
  'CULTO x Neo Pistea — la colección': { EN: 'CULTO x Neo Pistea — the collection', PT: 'CULTO x Neo Pistea — a coleção', DE: 'CULTO x Neo Pistea — die Kollektion', FR: 'CULTO x Neo Pistea — la collection', IT: 'CULTO x Neo Pistea — la collezione' },
  'La Ciudad del Pop x Mir Nicolás — la colección': { EN: 'La Ciudad del Pop x Mir Nicolás — the collection', PT: 'La Ciudad del Pop x Mir Nicolás — a coleção', DE: 'La Ciudad del Pop x Mir Nicolás — die Kollektion', FR: 'La Ciudad del Pop x Mir Nicolás — la collection', IT: 'La Ciudad del Pop x Mir Nicolás — la collezione' },
  // Las intros, una por lookbook.
  'La colección Faith puesta, en Buenos Aires. Julio 2026.': { EN: 'The Faith collection worn, in Buenos Aires. July 2026.', PT: 'A coleção Faith vestida, em Buenos Aires. Julho de 2026.', DE: 'Die Faith-Kollektion getragen, in Buenos Aires. Juli 2026.', FR: 'La collection Faith portée, à Buenos Aires. Juillet 2026.', IT: 'La collezione Faith indossata, a Buenos Aires. Luglio 2026.' },
  'La colección FW26 puesta, en Rio de Janeiro. Fotos de Fili.': { EN: 'The FW26 collection worn, in Rio de Janeiro. Photos by Fili.', PT: 'A coleção FW26 vestida, no Rio de Janeiro. Fotos de Fili.', DE: 'Die FW26-Kollektion getragen, in Rio de Janeiro. Fotos von Fili.', FR: 'La collection FW26 portée, à Rio de Janeiro. Photos de Fili.', IT: 'La collezione FW26 indossata, a Rio de Janeiro. Foto di Fili.' },
  'El merch oficial del disco. Neo con las remeras puestas arriba del escenario en Mar del Plata, y el shooting de la colección en Buenos Aires. Verano 2025.': { EN: 'The official album merch. Neo wearing the tees on stage in Mar del Plata, and the collection shoot in Buenos Aires. Summer 2025.', PT: 'O merch oficial do disco. Neo com as camisetas no palco em Mar del Plata, e o ensaio da coleção em Buenos Aires. Verão de 2025.', DE: 'Das offizielle Merch zum Album. Neo mit den Shirts auf der Bühne in Mar del Plata und das Shooting der Kollektion in Buenos Aires. Sommer 2025.', FR: "Le merch officiel de l'album. Neo avec les t-shirts sur scène à Mar del Plata, et le shooting de la collection à Buenos Aires. Été 2025.", IT: "Il merch ufficiale dell'album. Neo con le t-shirt sul palco a Mar del Plata, e lo shooting della collezione a Buenos Aires. Estate 2025." },
  'Arte exclusivo inspirado en el universo visual de Mir Nicolás y la cultura urbana japonesa. Tres gráficas en negro y en blanco, edición especial. Octubre de 2025.': { EN: "Exclusive art inspired by Mir Nicolás's visual universe and Japanese street culture. Three graphics in black and in white, special edition. October 2025.", PT: 'Arte exclusiva inspirada no universo visual de Mir Nicolás e na cultura urbana japonesa. Três gráficas em preto e em branco, edição especial. Outubro de 2025.', DE: 'Exklusive Kunst, inspiriert von der Bildwelt von Mir Nicolás und der japanischen Straßenkultur. Drei Grafiken in Schwarz und in Weiß, Sonderedition. Oktober 2025.', FR: "Art exclusif inspiré de l'univers visuel de Mir Nicolás et de la culture urbaine japonaise. Trois graphismes en noir et en blanc, édition spéciale. Octobre 2025.", IT: "Arte esclusiva ispirata all'universo visivo di Mir Nicolás e alla cultura urbana giapponese. Tre grafiche in nero e in bianco, edizione speciale. Ottobre 2025." },
  'El jersey fileteado por Alfredo Genovese, en la cancha de la Villa 31. Filete porteño sobre una camiseta de fútbol. Diciembre de 2025.': { EN: 'The jersey filete-painted by Alfredo Genovese, on the pitch in Villa 31. Fileteado porteño on a football shirt. December 2025.', PT: 'A camisa fileteada por Alfredo Genovese, na quadra da Villa 31. Filete portenho sobre uma camisa de futebol. Dezembro de 2025.', DE: 'Das von Alfredo Genovese im Filete-Stil bemalte Trikot, auf dem Platz der Villa 31. Fileteado porteño auf einem Fußballtrikot. Dezember 2025.', FR: 'Le maillot fileté par Alfredo Genovese, sur le terrain de la Villa 31. Fileteado porteño sur un maillot de football. Décembre 2025.', IT: 'La maglia filettata da Alfredo Genovese, sul campo della Villa 31. Fileteado porteño su una maglia da calcio. Dicembre 2025.' },
  'Cuarenta buzos tie dye, ninguno a la venta: se repartieron entre los streamers y creadores del momento. Septiembre de 2020.': { EN: 'Forty tie-dye hoodies, none for sale: they went to the streamers and creators of the moment. September 2020.', PT: 'Quarenta moletons tie dye, nenhum à venda: foram para os streamers e criadores do momento. Setembro de 2020.', DE: 'Vierzig Tie-Dye-Hoodies, keiner im Verkauf: Sie gingen an die Streamer und Creator der Stunde. September 2020.', FR: "Quarante hoodies tie dye, aucun en vente : ils sont allés aux streamers et créateurs du moment. Septembre 2020.", IT: 'Quaranta felpe tie dye, nessuna in vendita: sono andate agli streamer e ai creator del momento. Settembre 2020.' },
  // — CookieBanner —
