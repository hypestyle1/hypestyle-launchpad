...
export default function ConfirmacionPedido() {
  ...
  // MP return URL params: collection_status, external_reference, payment_id
    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <div className="flex-1 flex items-center justify-center px-4 py-16">
        <div className="max-w-[540px] w-full text-center">
          ...
          <h1 className="text-[26px] md:text-[32px] font-bold leading-tight mb-4">
            ¡Gracias por tu compra!
          </h1>
          <p className="text-[14px] text-muted-foreground leading-relaxed mb-2">
            Te enviamos un email con la confirmación y los detalles del pedido.
            Preparamos tu orden y te avisamos cuando esté en camino.
          </p>
          ...
          <div className="border-t border-border pt-8 mb-8 text-left space-y-2">
            ...
            <div className="flex justify-between text-[13px]">
              ...
              <span>Andreani — 5 a 10 días hábiles</span>
            </div>
          </div>

          <a href="/"
            className="inline-flex items-center gap-2 bg-bg-dark text-primary-foreground px-10 py-4 text-[12px] font-bold uppercase tracking-[0.1em] hover:bg-bg-dark/85 transition-colors">
            Seguir comprando
          </a>
        </div>
      </div>
