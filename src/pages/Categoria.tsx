...
const CATEGORY_MAP: Record<string, CategoryConfig> = {
  "/arriba/": {
    ...
    tabs: [
      ...
      { label: "Hoodies",     categories: ["Hoodie", "Crewneck"] },
      { label: "Remeras",     categories: ["Tee"] },
      { label: "Longsleeves", categories: ["Longsleeve"] },
      { label: "Sleeveless",  categories: ["Sleeveless", "Top"] },
      { label: "Jersey",      categories: ["Jersey"] },
    ],
  },
  "/abajo/": {
    title: "Abajo",
    ...
    tabs: [
      { label: "Todo",       categories: [] },
      { label: "Pantalones", categories: ["Pantalón"] },
      { label: "Jorts",      categories: ["Jort"] },
    ],
  },
  "/accesorios/": {
    title: "Accesorios",
  ...
  "/sets/": {
    ...
    tabs: [
      { label: "Todo",  categories: [] },
      { label: "Sets",  categories: ["Set"] },
      { label: "Packs", categories: ["Pack"] },
    ],
  },
  "/productos/": {
...
export default function Categoria() {
  ...
  const config = CATEGORY_MAP[pathname] ?? CATEGORY_MAP["/productos/"];
            ...
            <div className="max-w-[1400px] mx-auto px-4 flex items-center gap-0 overflow-x-auto scrollbar-none">
              {config.tabs.map((tab, i) => (
                <button
                  ...
                  className={`shrink-0 text-[12px] font-medium uppercase tracking-[0.1em] px-5 py-4 border-b-2 transition-colors whitespace-nowrap ${
                    activeTab === i
              ...
              <div className="flex items-center gap-1.5 flex-wrap">
                {availableSizes.map(s => (
                  <button
                    ...
                    className={`px-3 py-1 text-[11px] font-semibold uppercase tracking-wide border transition-colors rounded-[6px] ${
