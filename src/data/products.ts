...
• Construcción resistente`,
  ...
  {
    slug: "half-zip-polo-navy",
    id: "half-zip-polo-navy",
    name: "Half Zip Polo — Navy",
    category: "Polo",
    price: 87000,
    originalPrice: 145000,
    description: `HALF ZIP POLO — NAVY\n\nBuzo polo oversize con media cremallera, cuello de polo y gráficas bordadas. Confeccionado en rústico premium 100% algodón, con peso y estructura que lo hacen protagonista del outfit. Colorway navy con estampas en naranja.\n\n• Fit oversize\n• Rústico premium 100% algodón\n• Cuello polo con media cremallera\n• Gráficas bordadas: escudo, caballo, HypeStyle lettering\n• Número 18 en manga\n• Colorway Navy`,
    careItems: CARE_APPAREL,
    fit: "Oversize",
    sizes: ["S", "M", "L", "XL"],
    stock: { S: "ok", M: "ok", L: "ok", XL: "ok" },
    colors: [
      { label: "Navy",    value: "#212246", image: "products/half-zip-polo-navy-0.png" },
      { label: "Melange", value: "#9fa3a8", image: "products/half-zip-polo-grey-0.png" },
      { label: "Black",   value: "#1a1a1a", image: "products/half-zip-polo-black-0.png" },
    ],
    images: [
  ...
  },
  {
    ...
    price: 87000,
    originalPrice: 145000,
    description: `HALF ZIP POLO — MELANGE\n\nBuzo polo oversize con media cremallera, cuello de polo y gráficas bordadas. Confeccionado en rústico premium 100% algodón, con peso y estructura que lo hacen protagonista del outfit. Colorway melange con estampas en gris.\n\n• Fit oversize\n• Rústico premium 100% algodón\n• Cuello polo con media cremallera\n• Gráficas bordadas: escudo, caballo, HypeStyle lettering\n• Número 18 en manga\n• Colorway Melange`,
    careItems: CARE_APPAREL,
    fit: "Oversize",
    sizes: ["S", "M", "L", "XL"],
    stock: { S: "ok", M: "ok", L: "ok", XL: "ok" },
  ...
  {
    slug: "half-zip-polo-black",
    id: "half-zip-polo-black",
    name: "Half Zip Polo — Black",
    category: "Polo",
    price: 87000,
    originalPrice: 145000,
    description: `HALF ZIP POLO — BLACK\n\nBuzo polo oversize con media cremallera, cuello de polo y gráficas bordadas. Confeccionado en rústico premium 100% algodón, con peso y estructura que lo hacen protagonista del outfit. Colorway negro con estampas en blanco.\n\n• Fit oversize\n• Rústico premium 100% algodón\n• Cuello polo con media cremallera\n• Gráficas bordadas: escudo, caballo, HypeStyle lettering\n• Número 18 en manga\n• Colorway Black`,
    careItems: CARE_APPAREL,
    fit: "Oversize",
    sizes: ["S", "M", "L", "XL"],
    stock: { S: "ok", M: "ok", L: "ok", XL: "ok" },
